...
def add_or_update_user(username):
    '''Add or update user and their Tweets, error is no/private user.'''
    try:
        ...
        for tweet in tweets:
            ...
            embedding = BASILICA.embed_sentence(tweet.text, mode='twitter')
            db_tweet = Tweet(id=tweet.id, tweet=tweet.text[:500], embedding=embedding)
